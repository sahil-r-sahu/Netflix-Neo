...
export const auth = getAuth(); //we need to call this again & again whenever we use firebase api's So keeping it in a central place so that we dont need to call this again & again
